...
function Edit() {
    ...
    $.ajax({
        ...
        url: "http://localhost:53126/api/Lockers/" + $('#Id').val(),
        datatype: "json",
        data: locker,
...
function GetById(Id) {
    hideAlert();
    $.ajax({
        url: "http://localhost:53126/api/Lockers/" + Id, // search
        type: "GET",
        datatype: "json",
        success: function (result) {
            $('#Id').val(result.Id);
...
function Delete(Id) {
    swal({ // popup konfirmasi delete swal 
        ...
        $.ajax({
            url: "http://localhost:53126/api/Lockers/" + Id,
            type: "DELETE",
            success: function (response) {
                ...
                function () {
                    window.location.href = '/Lockers/Index'; // ini belum tau buat apa
                });
            },
