...
function Save() {
    debugger;
    var skill = new Object(); //deklarasikan object baru yang akan disimpan nilai nilai didalamnya
    skill.Name = $('#Name').val(); // simpan nilai yang ada di #Name di view kedalam object 
    $.ajax({
        type: "POST", //insert
        url: "http://localhost:53126/api/Skills",
        datatype: "json",
        data: skill, //data yang akan disimpan adalah object yang di deklarasikan tadi
...
function Edit() {
    var skill = new Object(); // sama kayak di save
    skill.Id = $('#Id').val();// id dari data yang akan diedit
    skill.Name = $('#Name').val();// data yang akan diedit
    $.ajax({
        type: "PUT", //put untuk update
        url: "http://localhost:53126/api/Skills/" + $('#Id').val(),
        datatype: "json",
        data: skill,
...
function GetById(Id) {
    hideAlert();
    $.ajax({
        url: "http://localhost:53126/api/Skills/" + Id, // search
        type: "GET",
        datatype: "json",
        success: function (result) {
            $('#Id').val(result.Id);
...
function Delete(Id) {
    swal({ // popup konfirmasi delete swal 
        ...
        $.ajax({
            url: "http://localhost:53126/api/Skills/" + Id,
            type: "DELETE",
            success: function (response) {
                ...
                function () {
                    window.location.href = '/Skills/Index'; // ini belum tau buat apa
                });
            },
