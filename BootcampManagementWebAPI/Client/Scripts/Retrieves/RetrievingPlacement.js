...
function Save() {
    ...
    university.Village_Id = $('#Village').val();// masih ragu disini
    $.ajax({
        type: "POST", //insert
        url: "http://localhost:53126/api/Placements",
        datatype: "json",
...
function Edit() {
    ...
    $.ajax({
        ...
        url: "http://localhost:53126/api/Placements/" + $('#Id').val(),
        datatype: "json",
        data: university,
...
function GetById(Id) {
    debugger;
    $.ajax({
        url: "http://localhost:53126/api/Placements/" + Id, // search
        type: "GET",
        datatype: "json",
        success: function (university) {
...
function Delete(Id) {
    swal({ // popup konfirmasi delete swal 
        ...
        $.ajax({
            url: "http://localhost:53126/api/Placements/" + Id,
            type: "DELETE",
            success: function (response) {
                ...
                function () {
                    window.location.href = '/Placements/Index'; // ini buat kembali ke halaman index setelah delete
                });
            },
