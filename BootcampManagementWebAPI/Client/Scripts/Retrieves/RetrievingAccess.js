...
function Edit() {
    ...
    $.ajax({
        ...
        url: "http://localhost:53126/api/Accesses/" + $('#Id').val(),
        datatype: "json",
        data: access,
...
function GetById(Id) {
    hideAlert();
    $.ajax({
        url: "http://localhost:53126/api/Acceses/" + Id, // search
        type: "GET",
        datatype: "json",
        success: function (result) {
            $('#Id').val(result.Id);
...
function Delete(Id) {
    swal({ // popup konfirmasi delete swal 
        ...
        $.ajax({
            url: "http://localhost:53126/api/Accesses/" + Id,
            type: "DELETE",
            success: function (response) {
                ...
                function () {
                    window.location.href = '/Accesss/Index'; // ini belum tau buat apa
                });
            },
